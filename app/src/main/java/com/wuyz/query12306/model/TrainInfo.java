...
public class TrainInfo {
    ...
    public String getLeftTicketInfo() {
        ...
        if (!isSellOut(gr_num)) {
            sb.append(PassengerData.SeatType.VAG_SLEEPER.getLabel()).append("(").append(gr_num).append("),");
        }
        if (!isSellOut(rw_num)) {
            sb.append(PassengerData.SeatType.SOFT_SLEEPER.getLabel()).append("(").append(rw_num).append("),");
        }
        if (!isSellOut(yw_num)) {
            sb.append(PassengerData.SeatType.HARD_SLEEPER.getLabel()).append("(").append(yw_num).append("),");
        }
        if (!isSellOut(rz_num)) {
            sb.append(PassengerData.SeatType.SOFT_SEAT.getLabel()).append("(").append(rz_num).append("),");
        }
        if (!isSellOut(yz_num)) {
            sb.append(PassengerData.SeatType.HARD_SEAT.getLabel()).append("(").append(yz_num).append("),");
        }
        if (!isSellOut(wz_num)) {
            sb.append(PassengerData.SeatType.NONE_SEAT.getLabel()).append("(").append(wz_num).append("),");
        }
        if (!isSellOut(swz_num)) {
            sb.append(PassengerData.SeatType.BUSS_SEAT.getLabel()).append("(").append(swz_num).append("),");
        }
        if (!isSellOut(tz_num)) {
            sb.append(PassengerData.SeatType.BEST_SEAT.getLabel()).append("(").append(tz_num).append("),");
        }
        if (!isSellOut(zy_num)) {
            sb.append(PassengerData.SeatType.ONE_SEAT.getLabel()).append("(").append(zy_num).append("),");
        }
        if (!isSellOut(ze_num)) {
            sb.append(PassengerData.SeatType.TWO_SEAT.getLabel()).append("(").append(ze_num).append("),");
        }
        if (!isSellOut(qt_num)) {
            sb.append(PassengerData.SeatType.OTH_SEAT.getLabel()).append("(").append(qt_num).append("),");
        }
...
/*
 ...
 {
 "queryLeftNewDTO":{
 "train_no":"6i000D312604",
 "station_train_code":"D3126",
 "start_station_telecode":"IOQ",
 "start_station_name":"深圳北",
 "end_station_telecode":"NJH",
 "end_station_name":"南京",
 "from_station_telecode":"XKS",
 "from_station_name":"厦门北",
 "to_station_telecode":"ARH",
 "to_station_name":"鳌江",
 "start_time":"10:46",
 "arrive_time":"13:58",
 "day_difference":"0",
 ...
 "canWebBuy":"N",
 "lishiValue":"192",
 "yp_info":"O014100000M016800000O014103000",
 ...
 {
 "queryLeftNewDTO":{
 "train_no":"5n000D330608",
 "station_train_code":"D3306",
 "start_station_telecode":"XKS",
 "start_station_name":"厦门北",
 ...
 "canWebBuy":"Y",
 "lishiValue":"197",
 "yp_info":"O014100000M016800000O014103001",
 "control_train_day":"20991231",
 "start_train_date":"20161002",
 "seat_feature":"O3M3W3",
 "yp_ex":"O0M0O0",
 ...
 "secretStr":"%3D",
 "buttonTextInfo":"预订"
 }
 ],
 "messages":[
